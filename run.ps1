...
$result = & $runtimeEntry -TargetRepoPath $TargetRepoPath -BatchSize $BatchSize -DRY_RUN:$DRY_RUN -RunId $RunId -AuditWorkspacePath $AuditWorkspacePath -CI_MODE:$CI_MODE -Mode $Mode
